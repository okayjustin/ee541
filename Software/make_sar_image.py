...
def main():
  ...
  parser.add_argument('-f', nargs='?', type=str, default='data/towardswarehouse.wav', help="Filename containing SAR data in appropriate format (default: mit-towardswarehouse.wav (prefix filename with 'mit-' to use MIT's frequency range if your VCO range is different))")
